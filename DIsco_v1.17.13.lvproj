...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="DIsco_CommList.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_CommList.vi"/>
		<Item Name="DIsco_HardFlowLimit.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_HardFlowLimit.vi"/>
		<Item Name="DIsco_Main.vi" Type="VI" URL="../DIsco_Main.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="DIsco_AddProgram.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_AddProgram.vi"/>
			<Item Name="DIsco_Alert.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Alert.vi"/>
			<Item Name="DIsco_Call.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Call.vi"/>
			<Item Name="DIsco_CallToSerial.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_CallToSerial.vi"/>
			<Item Name="DIsco_Comms.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Comms.vi"/>
			<Item Name="DIsco_ExtVarHist.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_ExtVarHist.vi"/>
			<Item Name="DIsco_FunctionCheck.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_FunctionCheck.vi"/>
			<Item Name="DIsco_GetCustomVar.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_GetCustomVar.vi"/>
			<Item Name="DIsco_GetSettings.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_GetSettings.vi"/>
			<Item Name="DIsco_Globals.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Globals.vi"/>
			<Item Name="DIsco_HardPressureLimit.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_HardPressureLimit.vi"/>
			<Item Name="DIsco_Heirarchy.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_Heirarchy.vi"/>
			<Item Name="DIsco_HoldCheck.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_HoldCheck.vi"/>
			<Item Name="DIsco_Import.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Import.vi"/>
			<Item Name="DIsco_InterpretConditional.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_InterpretConditional.vi"/>
			<Item Name="DIsco_ParseProgram.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_ParseProgram.vi"/>
			<Item Name="DIsco_PassVarValue.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_PassVarValue.vi"/>
			<Item Name="DIsco_Plot.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Plot.vi"/>
			<Item Name="DIsco_PlotSelect.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_PlotSelect.vi"/>
			<Item Name="DIsco_PumpListParse.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_PumpListParse.vi"/>
			<Item Name="DIsco_PumpStringToIndex.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_PumpStringToIndex.vi"/>
			<Item Name="DIsco_SaveAll.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_SaveAll.vi"/>
			<Item Name="DIsco_Serial_IO.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_Serial_IO.vi"/>
			<Item Name="DIsco_SetFlowStatus.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_SetFlowStatus.vi"/>
			<Item Name="DIsco_SetVar.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_SetVar.vi"/>
			<Item Name="DIsco_StatusToComment.vi" Type="VI" URL="../DIsco_Subs.llb/DIsco_StatusToComment.vi"/>
			<Item Name="DIsco_SubSelector.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_SubSelector.vi"/>
			<Item Name="DIsco_SubSub.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_SubSub.vi"/>
			<Item Name="DIsco_VarAutoUpdate.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_VarAutoUpdate.vi"/>
			<Item Name="DIsco_VariableMath.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_VariableMath.vi"/>
			<Item Name="DIsco_VarMathValue_Forward.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_VarMathValue_Forward.vi"/>
			<Item Name="DIsco_VarMathValue_Reverse.vi" Type="VI" URL="../DIsco_CustomPrograms.llb/DIsco_VarMathValue_Reverse.vi"/>
			<Item Name="GetDate1900.vi" Type="VI" URL="../DIsco_Subs.llb/GetDate1900.vi"/>
			<Item Name="lvStorage.dll" Type="Document" URL="lvStorage.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Parse_Digital.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_Digital.vi"/>
			<Item Name="Parse_Digital_IR.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_Digital_IR.vi"/>
			<Item Name="Parse_FlowPoint.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_FlowPoint.vi"/>
			<Item Name="Parse_GetAll.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_GetAll.vi"/>
			<Item Name="Parse_Identify.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_Identify.vi"/>
			<Item Name="Parse_Limits.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_Limits.vi"/>
			<Item Name="Parse_PressurePoint.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_PressurePoint.vi"/>
			<Item Name="Parse_RefillPoint.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_RefillPoint.vi"/>
			<Item Name="Parse_Status.vi" Type="VI" URL="../DIsco_Subs.llb/Parse_Status.vi"/>
			<Item Name="Round_NearestSigFig.vi" Type="VI" URL="../DIsco_Subs.llb/Round_NearestSigFig.vi"/>
		</Item>
